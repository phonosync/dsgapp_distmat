...
if not model:
    ...
    st.text("")
    st.text("")
    st.write("""Sample-Indices können in der ersten Spalte des hochgeladenen Datei angegeben werden. 
             Sie werden als Spalten- und Zeilen-Labels im Output-File verwendet. Wählen Sie in der folgenden Checkbox:""")
